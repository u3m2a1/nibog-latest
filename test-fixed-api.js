// Test the fixed PhonePe API endpoint
const crypto = require('crypto');

const testFixedAPI = async () => {
  try {
    console.log('Testing fixed PhonePe API endpoint...');
    ...
    // Test the payment initiation API with our internal endpoint
    console.log('Testing internal API endpoint...');
